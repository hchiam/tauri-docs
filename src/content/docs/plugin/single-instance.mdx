...
Ensure that a single instance of your tauri app is running at a time using the Single Instance Plugin. Can be integrated with the [deep link](/plugin/deep-link) plugin out of the box.
